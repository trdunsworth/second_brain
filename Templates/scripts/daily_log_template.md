...
**Role:** District Statistician, Area {{ AREA_NUM }} Director  
**Time Allocation:** {{ TM_TIME }}
...
## Afternoon / Evening ({{ AFTERNOON_START }} – {{ EVENING_END }})

### Continued Work / Deep Work Blocks 🎤
{{ AFTERNOON_WORK }}

### Personal Development 🎤
{{ PERSONAL_DEV_SECTION }}
...
|---|---|---|
| Completed Daily Mood Log (1+ entries) | [ ] Yes / [ ] No | Link: [[daily_mood_log_{{ LOG_DATE }}]] |
...
## Evening Reflection ({{ EVENING_REFLECTION_START }} – {{ EVENING_REFLECTION_END }})
...
### Sleep Target
**Lights out:** {{ SLEEP_TARGET }} | **Hours planned:** __
